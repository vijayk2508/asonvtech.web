...
var MAX_UID = 1e6,
  ...
  getTransitionDurationFromElement = function (e) {
    ...
    return r || o
      ? ((n = n.split(',')[0]),
        (i = i.split(',')[0]),
        (parseFloat(n) + parseFloat(i)) * MILLISECONDS_MULTIPLIER)
      : 0
  },
  ...
  mapData = (function () {
    ...
    return {
      set: function (n, i, r) {
        void 0 === n.key && ((n.key = { key: i, id: t }), t++),
          (e[n.key.id] = r)
      },
      get: function (t, n) {
      ...
      delete: function (t, n) {
        if (void 0 !== t.key) {
          var i = t.key
          i.key === n && (delete e[i.id], delete t.key)
        }
      },
    }
  })(),
  ...
  find = Element.prototype.querySelectorAll,
  findOne = Element.prototype.querySelector,
  defaultPreventedPreservedOnDispatch = (function () {
    var e = new CustomEvent('Bootstrap', { cancelable: !0 }),
      t = document.createElement('div')
    return (
      t.addEventListener('Bootstrap', function () {
        return null
      }),
      e.preventDefault(),
      t.dispatchEvent(e),
...
supportScopeQuery ||
  ((find = function (e) {
    ...
    var n = null
    try {
      ; (e = e.replace(scopeSelectorRegex, '#' + this.id)),
...
function bootstrapHandler(e, t) {
  return function n(i) {
    return n.oneOff && EventHandler.off(e, i.type, t), t.apply(e, [i])
  }
}
  ...
  return function i(r) {
    for (
      ...
      for (var s = o.length; s--;)
        if (o[s] === a)
          return i.oneOff && EventHandler.off(e, r.type, n), n.apply(a, [r])
    return null
  }
}
  ...
  trigger: function (e, t, n) {
    ...
    return (
      ...
      ((i = $.Event(t, n)),
        ...
        (E = i.isDefaultPrevented())),
      a
        ? (_ = document.createEvent('HTMLEvents')).initEvent(r, s, !0)
        : (_ = new CustomEvent(t, { bubbles: s, cancelable: !0 })),
      void 0 !== n &&
      ...
      (_.preventDefault(),
        ...
        Object.defineProperty(_, 'defaultPrevented', {
          get: function () {
            return !0
          },
        })),
      l && e.dispatchEvent(_),
      _.defaultPrevented && void 0 !== i && i.preventDefault(),
      _
    )
  },
},
...
var Manipulator = {
  ...
  getDataAttributes: function (e) {
    if (!e) return {}
    var t = _objectSpread2({}, e.dataset)
    return (
  ...
  SelectorEngine = {
    ...
    find: function (e, t) {
      ...
      return (
        ...
        (n = []).concat.apply(n, find.call(t, e))
      )
    },
    findOne: function (e, t) {
      return void 0 === t && (t = document.documentElement), findOne.call(t, e)
    },
  ...
  Carousel = (function () {
    function e(e, t) {
      ; (this._items = null),
        ...
        Data.setData(e, DATA_KEY$2, this)
    }
    var t = e.prototype
    return (
      (t.next = function () {
      ...
      (t._getConfig = function (e) {
        return (
          (e = _objectSpread2(_objectSpread2({}, Default), e)),
      ...
      (e.carouselInterface = function (t, n) {
        ...
        'object' == typeof n && (r = _objectSpread2(_objectSpread2({}, r), n))
        var o = 'string' == typeof n ? n : r.slide
        if ((i || (i = new e(t, r)), 'number' == typeof n)) i.to(n)
      ...
      (e.dataApiClickHandler = function (t) {
        ...
        if (n && n.classList.contains(CLASS_NAME_CAROUSEL)) {
          var i = _objectSpread2(
            _objectSpread2({}, Manipulator.getDataAttributes(n)),
            Manipulator.getDataAttributes(this),
          ),
            r = this.getAttribute('data-slide-to')
          r && (i.interval = !1),
            e.carouselInterface(n, i),
            r && Data.getData(n, DATA_KEY$2).to(r),
            t.preventDefault()
        }
      }),
      (e.getInstance = function (e) {
...
var NAME$3 = 'collapse',
  ...
  Collapse = (function () {
    function e(e, t) {
      ...
      for (
        var n = SelectorEngine.find(SELECTOR_DATA_TOGGLE$1),
        i = 0,
        r = n.length;
        i < r;
        i++
      ...
      ; (this._parent = this._config.parent ? this._getParent() : null),
        ...
        Data.setData(e, DATA_KEY$3, this)
    }
    var t = e.prototype
    return (
      (t.toggle = function () {
      ...
      (t.show = function () {
        ...
        if (
            ...
            (n = SelectorEngine.find(SELECTOR_ACTIVES, this._parent).filter(
              function (e) {
                return 'string' == typeof t._config.parent
                  ...
                  : e.classList.contains(CLASS_NAME_COLLAPSE)
              },
            )).length &&
            (n = null)
          ...
          if (n) {
            ...
            if (
              (i = o[0] ? Data.getData(o[0], DATA_KEY$3) : null) &&
              i._isTransitioning
            )
              return
          }
          if (
            ...
            n &&
              n.forEach(function (t) {
                r !== t && e.collapseInterface(t, 'hide'),
                  i || Data.setData(t, DATA_KEY$3, null)
              })
            ...
            EventHandler.one(this._element, TRANSITION_END, function () {
              t._element.classList.remove(CLASS_NAME_COLLAPSING),
                t._element.classList.add(CLASS_NAME_COLLAPSE, CLASS_NAME_SHOW),
                (t._element.style[a] = ''),
                t.setTransitioning(!1),
                EventHandler.trigger(t._element, EVENT_SHOWN)
            }),
        ...
        if (
          ...
          if (n > 0)
            for (var i = 0; i < n; i++) {
              ...
              o &&
                !o.classList.contains(CLASS_NAME_SHOW) &&
  ...
  Dropdown = (function () {
    function e(e, t) {
      ; (this._element = e),
        ...
        this._addEventListeners(),
        Data.setData(e, DATA_KEY$4, this)
    }
    var t = e.prototype
    return (
      (t.toggle = function () {
          ...
          if (
            ...
            if (!this._inNavbar) {
              ...
              'parent' === this._config.reference
                ...
                t.classList.add(CLASS_NAME_POSITION_STATIC),
            ...
            this._element.focus(),
              ...
              EventHandler.trigger(t, EVENT_SHOWN$1, n)
          }
        }
      }),
      (t.hide = function () {
        if (
          ...
          var t = e.getParentFromElement(this._element),
            n = { relatedTarget: this._element }
          EventHandler.trigger(t, EVENT_HIDE$1, n).defaultPrevented ||
            (this._popper && this._popper.destroy(),
              Manipulator.toggleClass(this._menu, CLASS_NAME_SHOW$1),
              Manipulator.toggleClass(this._element, CLASS_NAME_SHOW$1),
              EventHandler.trigger(t, EVENT_HIDDEN$1, n))
        }
      }),
      (t.dispose = function () {
      ...
      (t._getPlacement = function () {
        var e = this._element.parentNode,
          t = PLACEMENT_BOTTOM
        return (
          e.classList.contains(CLASS_NAME_DROPUP)
            ? ((t = PLACEMENT_TOP),
              this._menu.classList.contains(CLASS_NAME_MENURIGHT) &&
              (t = PLACEMENT_TOPEND))
            : e.classList.contains(CLASS_NAME_DROPRIGHT)
              ? (t = PLACEMENT_RIGHT)
              : e.classList.contains(CLASS_NAME_DROPLEFT)
                ? (t = PLACEMENT_LEFT)
                : this._menu.classList.contains(CLASS_NAME_MENURIGHT) &&
                (t = PLACEMENT_BOTTOMEND),
          t
        )
      }),
      ...
      (t._getOffset = function () {
        ...
        return (
          'function' == typeof this._config.offset
            ? (t.fn = function (t) {
              return (
                (t.offsets = _objectSpread2(
                  _objectSpread2({}, t.offsets),
      ...
      (t._getPopperConfig = function () {
        ...
        return (
          ...
          _objectSpread2(_objectSpread2({}, e), this._config.popperConfig)
        )
      }),
      ...
      (e.clearMenus = function (t) {
        if (
          !t ||
          (t.button !== RIGHT_MOUSE_BUTTON &&
            ('keyup' !== t.type || t.key === TAB_KEY))
        )
          for (
            ...
            if ((t && 'click' === t.type && (s.clickEvent = t), a)) {
              ...
              if (n[i].classList.contains(CLASS_NAME_SHOW$1))
                if (
                  ...
                  if (
                    !EventHandler.trigger(o, EVENT_HIDE$1, s).defaultPrevented
                  ) {
                    var E
                    ...
                    n[i].setAttribute('aria-expanded', 'false'),
                      ...
                      EventHandler.trigger(o, EVENT_HIDDEN$1, s)
                  }
            }
          }
      }),
      ...
      (e.dataApiKeydownHandler = function (t) {
        if (
          !(/input|textarea/i.test(t.target.tagName)
            ? t.key === SPACE_KEY ||
            (t.key !== ESCAPE_KEY &&
              ((t.key !== ARROW_DOWN_KEY && t.key !== ARROW_UP_KEY) ||
                t.target.closest(SELECTOR_MENU)))
            : !REGEXP_KEYDOWN.test(t.key)) &&
          (t.preventDefault(),
            t.stopPropagation(),
          ...
          if (i && t.key !== SPACE_KEY) {
            var r = SelectorEngine.find(SELECTOR_VISIBLE_ITEMS, n).filter(
              isVisible,
            )
            if (r.length) {
              var o = r.indexOf(t.target)
              t.key === ARROW_UP_KEY && o > 0 && o--,
                t.key === ARROW_DOWN_KEY && o < r.length - 1 && o++,
                r[(o = -1 === o ? 0 : o)].focus()
            }
          } else e.clearMenus()
        }
...
var NAME$5 = 'modal',
  ...
  Modal = (function () {
    function e(e, t) {
      ; (this._config = this._getConfig(t)),
        (this._element = e),
        (this._dialog = SelectorEngine.findOne(SELECTOR_DIALOG, e)),
        (this._backdrop = null),
        (this._isShown = !1),
        ...
        Data.setData(e, DATA_KEY$5, this)
    }
    var t = e.prototype
    return (
      (t.toggle = function (e) {
      ...
      (t._getConfig = function (e) {
        return (
          (e = _objectSpread2(_objectSpread2({}, Default$3), e)),
      ...
      (t._showElement = function (e) {
        ...
        if (n) {
          ...
          EventHandler.one(this._dialog, TRANSITION_END, r),
            emulateTransitionEnd(this._dialog, o)
        } else r()
      }),
      ...
      (t._showBackdrop = function (e) {
        ...
        if (this._isShown && this._config.backdrop) {
          ...
          if (this._element.classList.contains(CLASS_NAME_FADE)) {
            ...
            EventHandler.one(this._backdrop, TRANSITION_END, r),
              emulateTransitionEnd(this._backdrop, o)
          } else r()
        } else e()
      }),
...
function sanitizeHtml(e, t, n) {
  ...
  for (
    ...
    o = Object.keys(t),
    a = (i = []).concat.apply(i, r.body.querySelectorAll('*')),
    s = function (e, n) {
      var i,
        r = a[e],
    ...
    return (
      ...
      (t.toggle = function (e) {
        if (this._isEnabled)
          if (e) {
            ...
            n ||
              ((n = new this.constructor(e.target, this._getDelegateConfig())),
                Data.setData(e.target, t, n)),
      ...
      (t.show = function () {
        ...
        if (this.isWithContent() && this._isEnabled) {
          ...
          r.setAttribute('id', o),
            ...
            this.setContent(),
            this.config.animation && r.classList.add(CLASS_NAME_FADE$1)
          var a =
          ...
          if (
            (Data.setData(r, this.constructor.DATA_KEY, this),
              ...
              r.classList.add(CLASS_NAME_SHOW$3),
              'ontouchstart' in document.documentElement)
          )
            (l = []).concat
          ...
          var _ = function () {
            ...
            var t = e._hoverState
              ; (e._hoverState = null),
                EventHandler.trigger(e.element, e.constructor.Event.SHOWN),
                t === HOVER_STATE_OUT && e._leave(null, e)
          }
          if (this.tip.classList.contains(CLASS_NAME_FADE$1)) {
            var c = getTransitionDurationFromElement(this.tip)
            EventHandler.one(this.tip, TRANSITION_END, _),
              emulateTransitionEnd(this.tip, c)
          } else _()
        }
      }),
      (t.hide = function () {
        var e = this,
          ...
          n = function () {
            e._hoverState !== HOVER_STATE_SHOW &&
              ...
              EventHandler.trigger(e.element, e.constructor.Event.HIDDEN),
              e._popper.destroy()
          }
        if (
      ...
      (t._enter = function (e, t) {
        var n = this.constructor.DATA_KEY
          ; (t = t || Data.getData(e.target, n)) ||
            ((t = new this.constructor(e.target, this._getDelegateConfig())),
              Data.setData(e.target, n, t)),
            e &&
            (t._activeTrigger[
      ...
      (t._getConfig = function (e) {
        ...
        return (
          ...
          'number' ==
          typeof (e = _objectSpread2(
            _objectSpread2(_objectSpread2({}, this.constructor.Default), t),
            'object' == typeof e && e ? e : {},
          ...
          e.sanitize &&
          (e.template = sanitizeHtml(e.template, e.whiteList, e.sanitizeFn)),
          e
        )
      }),
      ...
      (t._fixTransition = function () {
        ...
        null === e.getAttribute('x-placement') &&
          (e.classList.remove(CLASS_NAME_FADE$1),
    ...
    function e(e, t) {
      var n = this
        ; (this._element = e),
          ...
          EventHandler.on(this._scrollElement, EVENT_SCROLL, function (e) {
            return n._process(e)
          }),
          this.refresh(),
          this._process(),
          Data.setData(e, DATA_KEY$8, this)
    }
    var t = e.prototype
    return (
      (t.refresh = function () {
        var e = this,
          ...
          ; (this._offsets = []),
            ...
            SelectorEngine.find(this._selector)
              .map(function (e) {
                var t,
                  r = getSelectorFromElement(e)
                if ((r && (t = SelectorEngine.findOne(r)), t)) {
                  var o = t.getBoundingClientRect()
                  if (o.width || o.height) return [Manipulator[n](t).top + i, r]
                }
                return null
              })
              .filter(function (e) {
    ...
    return (
      (t.show = function () {
        ...
        if (
          ...
          if (
            (t &&
              (o = EventHandler.trigger(t, EVENT_HIDE$3, {
      ...
      (t._activate = function (e, t, n) {
        ...
        if (r && o) {
          ...
          r.classList.remove(CLASS_NAME_SHOW$5),
            EventHandler.one(r, TRANSITION_END, a),
            emulateTransitionEnd(r, s)
        } else a()
      }),
  ...
  Toast = (function () {
    function e(e, t) {
      ; (this._element = e),
        ...
        (this._timeout = null),
        this._setListeners(),
        Data.setData(e, DATA_KEY$a, this)
    }
    var t = e.prototype
    return (
      (t.show = function () {
